    ...
    <div class="content">
        ...
        <el-dialog :title="id == 0 ? '添加':'修改'" :visible.sync="dialogVisible" width="30%">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="dialogVisible = false;id = 0;newDes = '';newName='';newDepart='信息中心';newLevel=1;newHint=''">取 消</el-button>
        ...
        <el-dialog title="确认删除" :visible.sync="deleteVisiable" width="30%">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="deleteVisiable = false;id = 0;newDes = '';newName='';newDepart='信息中心';newLevel=1;newHint=''">取 消</el-button>
