<template>
    <div class="content">
        ...
        :highlight-current-row="true" :header-cell-style="{background:'#eef1f6',color:'#606266'}">
            ...
            <el-table-column prop="apartment" label="所属部门"></el-table-column>
        ...
        <el-dialog :title="id == 0 ? '添加':'修改'" :visible.sync="dialogVisible" width="30%">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="dialogVisible = false;id = 0;newDes = '';newName='';newDepart='信息中心';newLevel=1;newSecret=1;newUseful=1;newHint=''">取 消</el-button>
        ...
        <el-dialog title="确认删除" :visible.sync="deleteVisiable" width="30%">
            ...
            <span slot="footer" class="dialog-footer">
                <el-button @click="deleteVisiable = false;id = 0;newDes = '';newName='';newDepart='信息中心';newLevel=1;newSecret=1;newUseful=1;newHint=''">取 消</el-button>
...
<script src="./applied-asset.js"></script> 
<style lang="scss" src="./applied-asset.scss" scoped></style>